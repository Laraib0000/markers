...
class GooglePolylineScreen extends StatefulWidget {
  double latitude;
  double longitude;
  GooglePolylineScreen({required this.latitude, required this.longitude});
  @override
  _GooglePolylineScreenState createState() => _GooglePolylineScreenState();
}

class _GooglePolylineScreenState extends State<GooglePolylineScreen> {
